            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST" class="needs-validation">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control @if($errors->has('title')) is-invalid @endif" id="title" name="title" value="{{ old('title', $product->title) }}">
                        @if($errors->has('title'))
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @if($errors->has('quantity')) is-invalid @endif" id="quantity" name="quantity" placeholder="5" value="{{ old('quantity', $product->quantity) }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @if($errors->has('description')) is-invalid @endif" id="description" name="description">{{ old('description', $product->description) }}</textarea>
